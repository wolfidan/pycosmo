...
/*-----------------------------------------------
              @(target):= _interp1_c.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__interp1_c

#else
#  define SWIG_init    init_interp1_c

#endif
#define SWIG_name    "_interp1_c"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_interp1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:interp1",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  {
    npy_intp dims[1];
    if (!PyInt_Check(obj0))
    {
  ...
  result = (float *)interp1(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"interp1", _wrap_interp1, METH_VARARGS, NULL},
